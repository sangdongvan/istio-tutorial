...
NOTE: You may want to push some load onto the deployed applications in order to see some metrics.  Run `siege customer-tutorial.$(minishift ip).nip.io` to produce load.
...
open http://grafana-istio-system.{appdomain}/d/1/istio-dashboard?refresh=5s&orgId=1
or
firefox http://grafana-istio-system.{appdomain}/d/1/istio-dashboard?refresh=5s&orgId=1
endif::workshop[]
...
or
firefox "$(minishift openshift service grafana -u)/d/UbsSZTDik/istio-workload-dashboard?refresh=5s&orgId=1"
endif::workshop[]
----
...
----
ifdef::workshop[]
open http://prometheus-istio-system.{appdomain}/graph?g0.range_input=5m&g0.expr=&g0.tab=0"
or
firefox http://prometheus-istio-system.{appdomain}/graph?g0.range_input=5m&g0.expr=&g0.tab=0"
endif::workshop[]
